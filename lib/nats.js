 ...
 * Module Dependencies
 *
 * @requires https://github.com/Wolfy87/EventEmitter
 */
var NATS = (function(){
  // cLc
  // var net    = require('net'),
  ...
  */
   ...
   * FIXME FIXME FIXME
   * @see http://stackoverflow.com/questions/1240408/reading-bytes-from-a-javascript-string
   *
   * @api private
  */
  ...
  */
  ...
  Client.prototype.createConnection = function() {
    ...
    var stream    = new WebSocket(scheme + window.location.host + '/nats/');
    ...
    stream.onclose =  function(hadError) {
      if (hadError) { return; }
      client.closeStream();
